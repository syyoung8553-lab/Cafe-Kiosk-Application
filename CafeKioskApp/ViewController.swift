...
final class ViewController: UIViewController {
    ...
    private let coffeeMenus: [MenuItem] = [
        ...
        .init(name: "헤이즐넛라떼", imageName: "Hazelnutlatte", price: 4500),
        .init(name: "카페모카", imageName: "CafeMoka", price: 4800)
    ]

    // ✅ 아직 이미지 없으면 nil → 기본 아이콘(photo) 표시
